    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resume', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='scores', to='hirebridge.resume')),
            ],
        ),
        migrations.CreateModel(
            name='Certification',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('shortlisted', 'Shortlisted'), ('rejected', 'Rejected'), ('accepted', 'Accepted')], default='pending', max_length=15)),
                ('admin', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='applications', to='hirebridge.adminprofile')),
                ('resume', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applications', to='hirebridge.resume')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applications', to='hirebridge.userprofile')),
            ],
        ),
        migrations.CreateModel(
            name='WorkExperience',
